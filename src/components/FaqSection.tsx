...
function FaqItem(props) {
    return (
        <div className="sb-faq-section-item border-b mb-10" data-sb-field-path={props['data-sb-field-path']}>
            {props.question && (
            ...
            {props.answer && (
                <Markdown
                    ...
                    className={classNames('sb-markdown m-14', props?.styles?.answer ? mapStyles(props?.styles?.answer) : null, {
